...
date: 2025
icon: 💬
title: NLP/LLM을 이용한 일상 대화 요약
description: 일상 생활에서 발생하는 다양한 한국어 대화를 빠르게 요약해주는 모델을 개발합니다. Encoder-Decoder 아키텍처 기반의 모델들과 Decoder-only 아키텍처 기반의 LLM 모델들을 비교하며 데이터 증강과 QLoRA 파인튜닝을 통해 리더보드 1위 성과를 달성했습니다.
---
